...
function startGame(people1 = null, people2 = null, people3 = null, people4 = null) {
    mode = 'easy'
    IS_ONLINE = false;
    $('#menu').fadeOut();
    $('#singleMatch').fadeIn();
    ...
    if($('#singleMatch').css("display") !=="none"){
        $(".playerUser").css("height","47vh");
    }
}

function createSinglegame(people1, people2, people3, people4) {
    $('#createLobby').remove();
    $('#mask').remove();
    startGame(people1, people2, people3, people4);
}
